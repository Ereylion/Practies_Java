...
public class Game_2 {
    ...
    public Game_2(String fp, String sp) {
    ...
    public static void main(String[] args) {
        System.out.println(new Game_2("33584", "12312").play());
        System.out.println(new Game_2("94321", "48851").play());
        System.out.println(new Game_2("24242", "72605").play());
    }
}
